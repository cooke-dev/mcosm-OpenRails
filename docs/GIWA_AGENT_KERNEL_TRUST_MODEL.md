...
Administrative mutations use short-lived Workspace commands bound to an exact payload, Workspace revision, and monotonic nonce. Proof checkpoints bind the signer, Pact terms hash, Paycard, index, evidence, and expiry.
